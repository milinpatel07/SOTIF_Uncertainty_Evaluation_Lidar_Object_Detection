...
\begin{enumerate}
    ...
    \item \textbf{Cross-domain consistency.} The methodology produces consistent uncertainty patterns across CARLA and KITTI, suggesting simulated data can complement real-world data for initial SOTIF evaluation.
\end{enumerate}
